...
const Card = ({ item }) => {
    ...
    return (
        <>
            <div className='relative shrink-0 w-24 h-32 sm:w-40 sm:h-48 bg-gray-900 overflow-hidden cursor-pointer rounded transition-all duration-300 hover:scale-105 hover:shadow-2xl'>
