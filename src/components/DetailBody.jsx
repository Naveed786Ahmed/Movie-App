    ...
    return (
        <>
            <div className='w-full px-4 py-2 sm:p-4 sm:px-12'>
                ...
                <button className='px-3 sm:px-4 py-2 flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-600 active:scale-95 rounded-xl text-white text-sm sm:text-base font-bold cursor-pointer transition-all duration-200 ease-in-out shadow-lg shadow-amber-500/30 mb-2'>
